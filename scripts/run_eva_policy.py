...
"""
Author: Jie Wang
Usage: python3 scripts/run_eva_policy.py -n 1 -c pi0_policy

Version: 
   2025-04-17: start from collect_trajectory.py
   2025-09-14: add more controllers
"""
...
if __name__ == "__main__":
    ...
    parser.add_argument("-c","--controller", default=None, choices=["oculus", "keyboard", "gello", "spacemouse" ,
                                                                    "policy", "pi0_policy", "keyboard_pi0", "spacemouse_pi0", "replay_pi0"])  
