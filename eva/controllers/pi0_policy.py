    ...
    def forward(self, observation):
        ...
        if self.actions_from_chunk_completed == 0 or self.actions_from_chunk_completed >= self.open_loop_horizon:
            ...
            try:
                ...
                assert self.pred_action_chunk.shape == (10, 8), f"Expected action chunk shape (10, 8), got {self.pred_action_chunk.shape}"
